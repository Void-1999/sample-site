    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <section id="home" className="min-h-screen flex flex-col items-center justify-center bg-cover bg-center relative" 
        ...
        <div className="text-center relative z-10 px-4">
          <div className="mb-8">
            <Image src="/public/logo.png" alt="ForRest Of Us Logo" width={180} height={180} className="mx-auto" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all">
              <div className="h-60 relative overflow-hidden">
                <Image src="/images/jamming.jpg" alt="Jamming Sessions" layout="fill" objectFit="cover" />
              </div>
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all">
              <div className="h-60 relative overflow-hidden">
                <Image src="/images/education.jpg" alt="Education" layout="fill" objectFit="cover" />
              </div>
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all">
              <div className="h-60 relative overflow-hidden">
                <Image src="/images/climate.jpg" alt="Climate Change" layout="fill" objectFit="cover" />
              </div>
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all">
              <div className="h-60 relative overflow-hidden">
                <Image src="/images/film.jpg" alt="Film Screening" layout="fill" objectFit="cover" />
              </div>
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all">
              <div className="h-60 relative overflow-hidden">
                <Image src="/images/maker.jpg" alt="Maker's Space" layout="fill" objectFit="cover" />
              </div>
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all">
              <div className="h-60 relative overflow-hidden">
                <Image src="/images/food.jpg" alt="Food Lab" layout="fill" objectFit="cover" />
              </div>
              <div className="p-6">
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all">
                <div className="h-48 relative overflow-hidden">
                  <Image src="/images/workshop.jpg" alt="Slow Living Workshop" layout="fill" objectFit="cover" />
                </div>
                <div className="p-6">
              ...
              <div className="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all">
                <div className="h-48 relative overflow-hidden">
                  <Image src="/images/plantation.jpg" alt="Flowering Plants Plantation Drive" layout="fill" objectFit="cover" />
                </div>
                <div className="p-6">
              ...
              <div className="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all">
                <div className="h-48 relative overflow-hidden">
                  <Image src="/images/jamming-event.jpg" alt="Jamming Session" layout="fill" objectFit="cover" />
                </div>
                <div className="p-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all">
                <div className="h-48 relative overflow-hidden">
                  <Image src="/images/dead-poets.jpg" alt="Film Screening: Dead Poet's Society" layout="fill" objectFit="cover" />
                </div>
                <div className="p-6">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <a href="https://www.linkedin.com/feed/update/urn:li:activity:7310815074095435776" target="_blank" rel="noopener noreferrer" className="block group">
              <div className="rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all">
                <div className="h-72 relative overflow-hidden">
                  <Image src="/images/intro.jpg" alt="Introduction" layout="fill" objectFit="cover" className="group-hover:scale-105 transition-transform duration-300" />
                </div>
            ...
            <a href="https://www.linkedin.com/feed/update/urn:li:activity:7318192085512167424" target="_blank" rel="noopener noreferrer" className="block group">
              <div className="rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all">
                <div className="h-72 relative overflow-hidden">
                  <Image src="/images/education-story.jpg" alt="Education" layout="fill" objectFit="cover" className="group-hover:scale-105 transition-transform duration-300" />
                </div>
                <div className="p-6 bg-white">
            ...
            <a href="https://www.linkedin.com/feed/update/urn:li:activity:7324347337378525185" target="_blank" rel="noopener noreferrer" className="block group">
              <div className="rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all">
                <div className="h-72 relative overflow-hidden">
                  <Image src="/images/film-story.jpg" alt="Film Screenings" layout="fill" objectFit="cover" className="group-hover:scale-105 transition-transform duration-300" />
                </div>
                <div className="p-6 bg-white">
            ...
            <div className="rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all">
              <div className="h-72 relative overflow-hidden">
                <Image src="/images/jamming-story.jpg" alt="Jamming" layout="fill" objectFit="cover" />
              </div>
              <div className="p-6 bg-white">
          ...
          <div className="bg-gray-50 rounded-2xl overflow-hidden shadow-lg">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="h-96 lg:h-auto relative">
                <Image src="/images/stay.jpg" alt="Our Stay" layout="fill" objectFit="cover" />
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="md:flex">
                <div className="md:w-1/3">
                  <div className="h-80 md:h-full relative">
                    <Image src="/images/aditya.jpg" alt="Aditya Tripathi" layout="fill" objectFit="cover" />
                  </div>
                </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all">
              <div className="md:flex">
                <div className="md:w-1/3">
                  <div className="h-80 md:h-full relative">
                    <Image src="/images/vidipta.jpg" alt="Vidipta Bafna" layout="fill" objectFit="cover" />
                  </div>
                </div>
                <div className="p-6 md:w-2/3">
